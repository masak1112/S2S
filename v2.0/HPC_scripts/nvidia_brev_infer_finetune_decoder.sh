...
finetune_ckpt=/data/bing/S2S/v2.0/HPC_scripts/results/S2S/rollout_finetune_finetune_rollout_crps_multipsteps/training_checkpoints/rollout_ckpt_1400.tar
...
python -m torch.distributed.launch --master_port=29503 --nproc_per_node=$NUM_TASKS_PER_NODE ../inference.py \
    ...
    --run_num=finetune_rollout_crps_v2  \
