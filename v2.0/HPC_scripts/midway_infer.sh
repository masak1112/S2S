...
/project/pedramh/bing/env/bin/python -m torch.distributed.launch --nproc_per_node=$NUM_TASKS_PER_NODE ../inference.py --yaml_config=$config_file --run_num=si_c1
