...
# Configuration
CONFIG_FILE=/lustre/fs01/hackathons/teams/uchigaco/exp2.yaml
...
apptainer exec \
    --nv \
    --bind /lustre/fs01 \
    /lustre/fs01/hackathons/teams/uchigaco/pytorch_25.10.sif \
    bash -c "
        ...
        PYTHONPATH=/lustre/fs01/hackathons/teams/uchigaco/S2S/v2.0 \
        nsys profile \
            -w true \
            -t cuda,nvtx,cudnn,cublas \
            -o /lustre/fs01/hackathons/teams/uchigaco/nsys_report_%q{SLURM_JOB_ID} \
            --force-overwrite=true \
            torchrun \
            --standalone \
            --nproc_per_node=${NUM_GPUS} \
            /lustre/fs01/hackathons/teams/uchigaco/train_optimized.py \
